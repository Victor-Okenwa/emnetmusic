...
<!-- Main Content -->
                    ...
                    <?php include "./meta/topbar.php" ?>
                        ...
                        <h1 class="text-center" style="filter: drop-shadow(0 0 4px rgb(151, 15, 15));">Top Ten adds(likes) on Emnet</h1>
                            <table class="table-responsive table table-striped text-light" id="dataTable" cellspacing="0">
                                    <thead class="text-light" style="background: linear-gradient(00deg, #520a05, rgb(104, 3, 3));">
                                        <tr>
                                            <th>Thumbnail</th>
                                            <th>Artist</th>
                                            <th>Poster</th>
                            ...
                            $i = 0;
                            $top = "";
                                $query_adds = mysqli_query($conn, "SELECT * from songs order by adds desc LIMIT 10");
                                while($data_song = mysqli_fetch_assoc($query_adds)){
                                   ...
                                   ?>
                                   <tr style="<?= $unique_id == $data_song['creator_id'] ? "background: linear-gradient(00deg, #520a05, rgb(104, 3, 3));" : "" ?>">
                                            <td>
                                                <?php 
                            ...
                            <?php
                            echo  $num_on_top > 0 ? "<h6 class='text-center text-light'> {$num_on_top} of your posts made the list</h6>" : "<h6 class='text-center text-light'> None of your posts made the list</h6>";
                        if($top != ""){
